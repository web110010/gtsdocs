...
By default, caddy sets `X-Forwarded-For` in forwarded requests. To make this and rate limiting work, set the `trusted-proxies` configuration variable. See the [rate limiting](../../../api/ratelimiting) and [general configuration](../../../configuration/general) docs.
